            ...
            <div className="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form className="pt-3">
                ...
                <div className="mt-3 d-grid gap-2">
                  <a className="btn btn-block btn-primary btn-lg fw-medium auth-form-btn" href="../../index.html">SIGN UP</a>
                </div>
                <div className="text-center mt-4 fw-light"> Already have an account? <a href="login.html" className="text-primary">Login</a>
                </div>
              </form>
            </div>
          </div>
