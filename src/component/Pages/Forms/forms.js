                ...
                <div className="card-body">
                  ...
                  <form className="forms-sample material-form">
                    <div className="form-group">
                      ...
                      <label htmlFor="input" className="control-label">Username</label><i className="bar" />
                    </div>
                    <div className="form-group">
                      <input type="text" required="required" />
                      <label htmlFor="input" className="control-label">Email address</label><i className="bar" />
                    </div>
                    <div className="form-group">
                      <input type="text" required="required" />
                      <label htmlFor="input" className="control-label">Password</label><i className="bar" />
                    </div>
                    <div className="form-group">
                      <input type="text" required="required" />
                      <label htmlFor="input" className="control-label">Confirm Password</label><i className="bar" />
                    </div>
                    <div className="form-group">
                      <textarea required="required" defaultValue={""} />
                      <label htmlFor="textarea" className="control-label">Message</label><i className="bar" />
                    </div>
                    <div className="checkbox">
                      <label>
                        <input type="checkbox" defaultChecked="checked" /><i className="helper" />Remember me </label>
                    </div>
                    <div className="button-container">
                      <button type="button" className="button btn btn-primary"><span>Submit</span></button>
                    </div>
                  </form>
                </div>
              </div>
            ...
            <div className="col-md-6 grid-margin stretch-card">
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-description"> Add classes like <code>.form-select-lg</code> and <code>.form-select-sm</code>. </p>
                  <div className="form-group">
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <div className="form-group">
                    <div className="input-group">
                      <div className="input-group-prepend">
                        <button className="btn btn-outline-primary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</button>
                  ...
                  <div className="form-group">
                    <div className="input-group">
                      ...
                      <div className="input-group-append">
                        <button className="btn btn-facebook" type="button" style={{height: '44px'}}>
