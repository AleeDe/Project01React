                                      ...
                                      <th>
                                        <div className="form-check form-check-flat mt-0">
                                          <label className="form-check-label">
                                            <input type="checkbox" className="form-check-input" aria-checked="false" id="check-all" /><i className="input-helper" /></label>
                                        </div>
                                      </th>
                                      <th>Customer</th>
                                      <th>Company</th>
                            ...
                            <div className="card-body">
                              <div className="row">
                                <div className="col-lg-12">
                                  ...
                                  <div>
                                    <canvas className="my-auto" id="doughnutChart" />
                                  </div>
                                  <div id="doughnutChart-legend" className="mt-5 text-center" />
                                </div>
                              </div>
                            </div>
                          </div>
